...
class CfgWeapons
{
	...
	NEW_501_Inf_Helm_JLTS(Scruff,Scruff,Scruff.paa)
	...
	NEW_501_Inf_Helm_JLTS(Akaan,Akaan,Akaan.paa)
	NEW_501_Inf_Helm_JLTS(Corey,Corey,Corey.paa)
	NEW_501_Inf_Helm_JLTS(Koda,Koda,Koda.paa)
	NEW_501_Inf_Helm_JLTS(Duke,Duke,Duke.paa)
