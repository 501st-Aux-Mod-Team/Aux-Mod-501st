////////////////////////////////////////////////////////////////////
//DeRap: 442_ships\mandator\config.bin
...
class cfgpatches
{
	class 442_mandator
	{
		requiredAddons[] = {};
		weapons[] = {};
		units[] = {"mandator_base","mandator_body1_1","mandator_body2_1","mandator_body2_2","mandator_body3_1","mandator_body3_2","mandator_body4_1","mandator_body4_2","mandator_body4_3","mandator_body4_4","mandator_body4_5","mandator_body4_6","mandator_body4_7","mandator_body4_8","mandator_engine_1","mandator_engine_2","mandator_engine_3","mandator_hanger1_1","mandator_hanger2_1","mandator_hanger2_2","mandator_hanger3_1","mandator_hanger3_2","mandator_hanger4"};
	};
};
class Eventhandlers;
class CfgVehicles
{
	...
	class mandator_base: StaticShip
	{
		...
		destrType = 0;
		featureType = 2;
		multistructureparts[] = {{"mandator_body1_1","body1_1"},{"mandator_body2_1","body2_1"},{"mandator_body2_2","body2_2"},{"mandator_body3_1","body3_1"},{"mandator_body3_2","body3_2"},{"mandator_body4_1","body4_1"},{"mandator_body4_2","body4_2"},{"mandator_body4_3","body4_3"},{"mandator_body4_4","body4_4"},{"mandator_body4_5","body4_5"},{"mandator_body4_6","body4_6"},{"mandator_body4_7","body4_7"},{"mandator_body4_8","body4_8"},{"mandator_engine_1","engine_1"},{"mandator_engine_2","engine_2"},{"mandator_engine_3","engine_3"},{"mandator_hanger1_1","hanger1_1"},{"mandator_hanger2_1","hanger2_1"},{"mandator_hanger2_2","hanger2_2"},{"mandator_hanger3_1","hanger3_1"},{"mandator_hanger3_2","hanger3_2"},{"mandator_hanger4","hanger4"}};
		class Eventhandlers
		{
	...
	class mandator_body1_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\body1_co.paa"};
	};
	class mandator_body2_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\body2_co.paa"};
	};
	...
	class mandator_body3_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\body3_co.paa"};
	};
	...
	class mandator_body4_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\body4_co.paa"};
	};
	...
	class mandator_engine_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\engine_co.paa"};
	};
	...
	class mandator_hanger1_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\hanger1_co.paa"};
	};
	class mandator_hanger2_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\hanger2_co.paa"};
	};
	...
	class mandator_hanger3_1: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\hanger3_co.paa"};
	};
	...
	class mandator_hanger4: mandator_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\mandator\data\hanger4_co.paa"};
	};
};
class cfgMods
{
