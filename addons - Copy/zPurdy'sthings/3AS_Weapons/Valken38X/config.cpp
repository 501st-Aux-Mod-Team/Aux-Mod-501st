...
class CfgWeapons
{
	...
	class 3AS_Valken38X_Base_F: Rifle_Base_F
	{
		...
		reloadAction="GestureReloadMX"; //GestureReloadMX, 3AS_GestureReloadValken38X
		...
		{
			"OFP2_ManSkeleton",
			//"3AS\3AS_Weapons\Valken38X\Data\Anim\Valken38X_handanim.rtm"
