...
class CfgWeapons
{
	...
	NEW_501_Pilot_HELM_Jlts(gothic,Gothic,pilots\Gothic.paa)
	NEW_501_Pilot_HELM_JLTS(Floff,Floff,pilots\Floff.paa)
	NEW_501_Pilot_HELM_JLTS(Frisk, Frisk, pilots\Frisk.paa)
	NEW_501_Pilot_HELM_JLTS(Gothic, Gothic, pilots\Gothic.paa)
	NEW_501_Pilot_HELM_JLTS(Shnuffles, Shnuffles, pilots\Shnuffles.paa)
	NEW_501_Pilot_HELM_JLTS(Legal, Legal, pilots\Legal.paa)
	NEW_501_Pilot_HELM_JLTS(Ethan, Ethan, pilots\Ethan.paa)
