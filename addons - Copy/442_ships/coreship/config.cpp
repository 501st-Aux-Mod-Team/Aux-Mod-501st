////////////////////////////////////////////////////////////////////
//DeRap: 442_ships\coreship\config.bin
//Produced from mikero's Dos Tools Dll version 7.46
//https://bytex.market/products/item/weodpphdknnzm70o0h8q/Mikero%27s%20Dos%20Tools
//'now' is Thu Jun 25 16:36:15 2020 : 'file' last modified on Sun Jun 07 11:07:51 2020
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class 442_coreship
	{
		requiredAddons[] = {};
		weapons[] = {};
		units[] = {"442_coreship","core_control_tower","core_core1","core_core2","core_core3","core_core4","core_platform1","core_platform2","core_platform3","core_platform4","core_radar"};
		author = "kripto202";
	};
};
class Eventhandlers;
class CfgVehicles
{
	...
	class 442_coreship: House_F
	{
		...
		multistructureparts[] = {{"core_control_tower","control_tower"},{"core_core1","core1"},{"core_core2","core2"},{"core_core3","core3"},{"core_core4","core4"},{"core_platform1","platform1"},{"core_platform2","platform2"},{"core_platform3","platform3"},{"core_platform4","platform4"},{"core_radar","radar"}};
		class Eventhandlers
		{
	...
	class core_control_tower: core_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\coreship\data\control_tower_co.paa"};
	};
	class core_core1: core_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\coreship\data\core_co.paa"};
	};
	...
	class core_platform1: core_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\coreship\data\platform_co.paa"};
	};
	...
	class core_radar: core_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\coreship\data\radar_co.paa"};
	};
};
class cfgMods
{
