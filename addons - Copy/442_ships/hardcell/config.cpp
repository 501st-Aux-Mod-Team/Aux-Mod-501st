////////////////////////////////////////////////////////////////////
//DeRap: 442_ships\hardcell\config.bin
...
class cfgpatches
{
	class 442_hardcell
	{
		requiredAddons[] = {};
		weapons[] = {};
		units[] = {"hardcell_base","hardcell_body","hardcell_engine1","hardcell_engine2","hardcell_engine3","hardcell_leg1","hardcell_leg2","hardcell_leg3"};
	};
};
class Eventhandlers;
class CfgVehicles
{
	...
	class hardcell_base: StaticShip
	{
		...
		destrType = 0;
		featureType = 2;
		multistructureparts[] = {{"hardcell_body","body"},{"hardcell_engine1","engine1"},{"hardcell_engine2","engine2"},{"hardcell_engine3","engine3"},{"hardcell_leg1","leg1"},{"hardcell_leg2","leg2"},{"hardcell_leg3","leg3"}};
		class Eventhandlers
		{
	...
	class hardcell_body: hardcell_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\hardcell\data\upper_co.paa"};
	};
	class hardcell_engine1: hardcell_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\hardcell\data\lower_co.paa"};
	};
