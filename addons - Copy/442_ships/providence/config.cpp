////////////////////////////////////////////////////////////////////
//DeRap: 442_ships\providence\config.bin
...
class CfgPatches
{
	class 442_providence
	{
		requiredAddons[] = {};
		weapons[] = {};
		units[] = {"442_providence","442_providence_d","providence_hull_base","providence_body1","providence_body1_d","providence_body2","providence_body2_d","providence_body3","providence_body3_d","providence_bridge","providence_bridge_d","providence_engine","providence_engine_d","providence_interior","providence_interior_d","442_providence_zeus","442_providence_d_zeus"};
		author = "kripto202";
	};
};
class Eventhandlers;
class CfgVehicles
{
	...
	class 442_providence: House_F
	{
		...
		multistructureparts[] = {{"providence_body1","body1"},{"providence_body2","body2"},{"providence_body3","body3"},{"providence_bridge","bridge"},{"providence_engine","engine"},{"providence_interior","interior"}};
		class Eventhandlers
		{
	...
	class 442_providence_d: House_F
	{
		...
		editorsubcategory = "442_ships";
		vehicleClass = "Structures";
		multistructureparts[] = {{"providence_body1_d","body1"},{"providence_body2_d","body2"},{"providence_body3_d","body3"},{"providence_bridge_d","bridge"},{"providence_engine_d","engine"},{"providence_interior_d","interior"}};
		class Eventhandlers
		{
			init = "_this call BIS_fnc_Destroyer01Init;";
			attributesChanged3DEN = "_this call BIS_fnc_Destroyer01PosUpdate;";
	...
	class providence_body1: providence_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\body1_co.paa"};
	};
	class providence_body1_d: providence_body1
	{
		displayname = "providence dreadnought body1";
		model = "\442_ships\providence\body1_d.p3d";
		hiddenselectionstextures[] = {"442_ships\providence\data\body1_d_co.paa"};
	};
	class providence_body2: providence_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\body2_co.paa"};
	};
	...
	class providence_body3: providence_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\body3_co.paa"};
	};
	...
	class providence_bridge: providence_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\bridge_co.paa"};
	};
	...
	class providence_engine: providence_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\engine_co.paa"};
	};
	...
	class providence_interior: providence_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\interior_co.paa"};
	};
	...
	class 442_providence_zeus: House_F
	{
		...
		hiddenselections[] = {"body1","body2","body3","bridge","engine","interior"};
		hiddenselectionstextures[] = {"442_ships\providence\data\body1_co.paa","442_ships\providence\data\body2_co.paa","442_ships\providence\data\body3_co.paa","442_ships\providence\data\bridge_co.paa","442_ships\providence\data\engine_co.paa","442_ships\providence\data\interior_co.paa"};
	};
	class 442_providence_d_zeus: 442_providence_zeus
	{
		...
		hiddenselectionstextures[] = {"442_ships\providence\data\body1_d_co.paa","442_ships\providence\data\body2_co.paa","442_ships\providence\data\body3_co.paa","442_ships\providence\data\bridge_co.paa","442_ships\providence\data\engine_co.paa","442_ships\providence\data\interior_co.paa"};
	};
};
class cfgMods
{
