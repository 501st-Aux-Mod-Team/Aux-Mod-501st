////////////////////////////////////////////////////////////////////
//DeRap: 442_ships\recusant\config.bin
...
class CfgPatches
{
	class 442_recusant
	{
		requiredAddons[] = {};
		weapons[] = {};
		units[] = {"recusant_zeus","recusant_zeus_d","rec_body1","rec_body2","rec_engine","rec_body1_d","rec_body2_d","rec_engine_d"};
		author = "kripto202";
	};
};
class Eventhandlers;
class CfgVehicles
{
	...
	class recusant_zeus: House_F
	{
		...
		hiddenselections[] = {"body1","body2","engine"};
		hiddenselectionstextures[] = {"442_ships\recusant\data\body1_co.paa","442_ships\recusant\data\body2_co.paa","442_ships\recusant\data\engine_co.paa"};
	};
	...
	class recusant_base: StaticShip
	{
		...
		destrType = 0;
		featureType = 2;
		multistructureparts[] = {{"rec_body1","body1"},{"rec_body2","body2"},{"rec_engine","engine"}};
		class Eventhandlers
		{
	...
	class recusant_base_d: recusant_base
	{
		...
		multistructureparts[] = {{"rec_body1_d","body1"},{"rec_body2_d","body2"},{"rec_engine_d","engine"}};
	};
	...
	class rec_body1: rec_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\recusant\data\body1_co.paa"};
	};
	...
	class rec_body2: rec_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\recusant\data\body2_co.paa"};
	};
	...
	class rec_engine: rec_hull_base
	{
		...
		hiddenselectionstextures[] = {"442_ships\recusant\data\engine_co.paa"};
	};
