class ACE_SelfActions: ACE_SelfActions
{
    class RD501_Style_Changer
    {
        ...
        class RD501_Style_Scuba: RD501_NoseArt_None
        {
            ...
            statement="_target setObjectMaterialGlobal [0, 'RD501_Laat\textures\rvmats\laat_mk3_fuselage_scuba.rvmat']";
        };
        ...
        {
            displayName="Mouth";
            statement="_target setObjectMaterialGlobal [0, 'RD501_Laat\textures\rvmats\laat_mk3_fuselage_mouth.rvmat']";
        };
        ...
        {
            displayName="Nexu";
            statement="_target setObjectMaterialGlobal [0, 'RD501_Laat\textures\rvmats\laat_mk3_fuselage_nexu.rvmat']";
        };
